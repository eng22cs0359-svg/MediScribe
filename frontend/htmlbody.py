...
def combined_mail_body(medicines_list, patient_name=""):
    ...
    greeting = (f"<p style='font-size:16px;color:#333;'>Dear <b>{patient_name}</b>,</p>"
                if patient_name and patient_name not in ("", "Not Mentioned") else "")
      ...
      <table width="600" cellpadding="0" cellspacing="0"
        ...
        <tr><td style="padding:30px 40px;">
          ...
          <p style="font-size:13px;color:#888;margin-top:24px;">
            💡 <i>Always take medicines with water unless directed otherwise.
            Consult your doctor if you experience any side effects.</i>
          </p>
        </td></tr>
        <tr><td style="background:#f0ebff;padding:20px 40px;text-align:center;">
          <p style="color:#6437b8;font-size:13px;margin:0;font-weight:600;">
            MediScribe — Your Prescription Management Partner
          </p>
